...
class TestBtcData(unittest.TestCase):
    def test___init__(self):
        ...
        self.assertNotEqual(btcDataInit.bitrex, 0)
        self.assertNotEqual(btcDataInit.bitstamp, 0)
class TestETHData(unittest.TestCase):
    def test___init__(self):
        ...
        self.assertNotEqual(ethDataInit.bitrex, 0)
        self.assertNotEqual(ethDataInit.bitstamp, 0)